  ...
  app.slide.predefined = {
    onInit:function(slideElement){
      ...
      window.initializeRotary(con, 
                        [
                            "./content/img/predefined/icon-1.png", 
                            "./content/img/predefined/icon-3.png", 
                            "./content/img/predefined/icon-4.png",
                            "./content/img/predefined/icon-5.png",
                            "./content/img/predefined/icon-6.png",
                            "./content/img/predefined/icon-8.png",
                            "./content/img/predefined/icon-7.png",
                            "./content/img/predefined/icon-2.png",
                            "./content/img/predefined/icon-9.png"
