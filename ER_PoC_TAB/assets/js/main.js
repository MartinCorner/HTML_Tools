...
var paneToggle = $(".pane-toggle-container");
...
function state1() {
    ...
    rightMidPannel.transition({rotateY: "-70deg", scale : [1, 1], "background": "#1076c0", x : 0}, speed, ease);
    ...
    paneToggle.transition({ opacity : 0}, speed, ease);
...
//    panelContainer.transition({ x : 250}, speed, ease);
    ...
    rightMidPannel.transition({ rotateY: '0deg', "background": "#1076c0", scale : [1, 1],  x : 0}, speed, ease);
    ...
    rightPannel.transition({ scale : [1, 1] , x : 75, "background": "#8e5417"}, speed, ease);
    leftPannel.transition({ scale : [1, 1.25], x : 0, "background": "#ffac56"}, speed, ease);
...
//    panelContainer.transition({ x : -250}, speed, ease);
    ...
    leftMidPannel.transition({ rotateY: '0deg', "background": "#1076c0", scale : [1, 1], x : 0}, speed, ease);
    rightMidPannel.transition({ rotateY: "-70deg", "background": "#fe8f1c", scale : [1, 1.25], x : 0}, speed, ease);
    ...
    paneToggle.transition({ opacity : 1}, speed, ease);

    rightPannel.transition({ scale : [1, 1.25], x : 0, "background": "#ffac56"}, speed, ease);
    leftPannel.transition({ scale : [1, 1], x : -75, "background": "#8e5417"}, speed, ease);
